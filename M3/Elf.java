...
public class Elf extends JFrame {
    ...
    public Elf () {
        ...
        //AIDA
        Image image1 = screen.getImage("Elf_1.JPG");
        this.setIconImage(image1);

        //MARTÍ
        Image image2 = screen.getImage("Elf_2.JPG");
        this.setIconImage(image2);

        //SANDRA
        Image image3 = screen.getImage("Elf_3.JPG");
    ...
    public void initComponent() {
        ...
        label[0].setFont(new Font("Waree", Font.PLAIN, 20));
        label[0].setHorizontalAlignment(JLabel.CENTER); //Centrar texto

        label[9] = new JLabel("EJEMPLO");
        label[9].setFont(new Font("Waree", Font.PLAIN, 10));

        label[1] = new JLabel("STATS");
        label[1].setFont(new Font("Waree", Font.PLAIN, 20));

        label[10] = new JLabel("EJEMPLO");
        label[10].setFont(new Font("Waree", Font.PLAIN, 10));

        label[2] = new JLabel("LORE");
        label[2].setFont(new Font("Waree", Font.PLAIN, 20));

        label[11] = new JLabel("EJEMPLO");
        label[11].setFont(new Font("Waree", Font.PLAIN, 10));
        ...
        label[3].setFont(new Font("Waree", Font.PLAIN, 20));
        label[3].setHorizontalAlignment(JLabel.CENTER); //Centrar texto

        label[12] = new JLabel("EJEMPLO");
        label[12].setFont(new Font("Waree", Font.PLAIN, 10));

        label[4] = new JLabel("STATS");
        label[4].setFont(new Font("Waree", Font.PLAIN, 20));

        label[13] = new JLabel("EJEMPLO");
        label[13].setFont(new Font("Waree", Font.PLAIN, 10));

        label[5] = new JLabel("LORE");
        label[5].setFont(new Font("Waree", Font.PLAIN, 20));

        label[14] = new JLabel("EJEMPLO");
        label[14].setFont(new Font("Waree", Font.PLAIN, 10));
        ...
        label[6].setFont(new Font("Waree", Font.PLAIN, 20));
        label[6].setHorizontalAlignment(JLabel.CENTER); //Centrar texto

        label[15] = new JLabel("EJEMPLO");
        label[15].setFont(new Font("Waree", Font.PLAIN, 10));

        label[7] = new JLabel("STATS");
        label[7].setFont(new Font("Waree", Font.PLAIN, 20));

        label[16] = new JLabel("EJEMPLO");
        label[16].setFont(new Font("FreeMono Bold", Font.PLAIN, 10));

        label[8] = new JLabel("LORE");
        label[8].setFont(new Font("FreeMono Bold", Font.PLAIN, 20));

        label[17] = new JLabel("EJEMPLO");
        label[17].setFont(new Font("Century Schoolbook L", Font.PLAIN, 10));
