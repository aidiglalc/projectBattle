...
// This class is the panel that we show in the dwarf selection

public class DwarfSelectionMenu extends JPanel {
    private BackgroundImageDwarfSelection backgroundImageDwarfSelection = new BackgroundImageDwarfSelection();
    private ArrayList<Character> dwarves;
    ...
    public DwarfSelectionMenu() {
        ...
        backgroundImageDwarfSelection.add(titlePanel);
        backgroundImageDwarfSelection.add(screenPanel);
        backgroundImageDwarfSelection.add(turnBackButtonPanel);

        add(backgroundImageDwarfSelection);
    ...
    public void initComponent() {
        ...
        imageIcon = new ImageIcon(System.getProperty("user.dir") + File.separator + "src" + File.separator + "Images" +
                File.separator + "Icons" + File.separator + "choose_your_dwarf.png");
        ...
        dwarves = new Character().getRace("Dwarf");

        // We initialize the panels for each character

        for(int i = 0; i < characterPanel.length ; i++){
            characterPanel[i] = new BorderImageDwarfSelection();
        ...
        for (int i = 0; i < dwarves.size(); i++) {
            ...
            imageIcon = new ImageIcon(System.getProperty("user.dir") + File.separator + "src" + File.separator + "Images" +
                    File.separator + "Characters" + File.separator + dwarves.get(i).getWarrior_image_path()); // We select the image from the array of elves
            ...
            label[labelCounter + 1] = new JLabel(dwarves.get(i).getWarrior_name());
            ...
            label[labelCounter + 3] = new JLabel("<html>Hit Points: " + dwarves.get(i).getHp() +
                    "<br>Strength: " + dwarves.get(i).getStrength() +
                    "<br>Defense: " + dwarves.get(i).getDefense() +
                    "<br>Agility: " + dwarves.get(i).getAgility() +
                    "<br>Speed: " + dwarves.get(i).getSpeed() + "</html>");
            ...
            label[labelCounter + 5]= new JLabel(dwarves.get(i).getWarrior_lore());
